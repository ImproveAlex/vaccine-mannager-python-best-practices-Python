...
class VaccineManager(metaclass=SingletonMetaclass):
    ...
    def cancel_appointment(self, input_file):
        """Metodo para cancelar una cita de vacunacion"""
        return VaccinationAppointment.cancel_appointment_from_json_file(input_file)
