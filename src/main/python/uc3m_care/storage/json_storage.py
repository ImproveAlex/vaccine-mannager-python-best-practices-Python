...
class JsonStore():
    ...
    def load( self ):
        ...
        try:
            ...
            raise VaccineManagementException(ErrorMsg.JSON_DECODE.value) \
    ...
    def save( self ):
        ...
        try:
            ...
            raise VaccineManagementException(ErrorMsg.NOT_FOUND_FILE.value) from ex
    ...
    def data_hash( self ):
        ...
        return hashlib.md5(self.data_list.__str__().encode()).hexdigest()
